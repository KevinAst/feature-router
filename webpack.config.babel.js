...
// ... ex: FROM: 'feature-router' TO: 'FeatureRouter'
const libraryName = () => {
...
const webpackConfig = {
  ...
  output: {
    ...
    filename:      packageInfo.name + (productionEnv ? '.min.js' : '.js'), // bundleFileName ... ex: feature-router.min.js

    library:       libraryName(), // bundle as a library (i.e. for external consumption) ....... ex: FeatureRouter
