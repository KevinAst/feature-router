...
import moduleFromBundle    from '../dist/feature-router';
import moduleFromBundleMin from '../dist/feature-router.min';
...
switch (MODULE_PLATFORM) {
  ...
  case undefined:
    ...
    break;
  case 'bundle':  
    console.log(`*** Testing Module Platform found in: dist/feature-router (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
    moduleUnderTest = moduleFromBundle;
    break;
  case 'bundle.min':  
    console.log(`*** Testing Module Platform found in: dist/feature-router.min (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
...
//***
//*** mimic same exports as project's index.js
//***

const { routeAspect,
        featureRoute,
        PRIORITY }     = moduleUnderTest;
